...
async function GameDetailPage({ 
  ...
  // 获取游戏特定翻译
  const gameTranslation = await getGameTranslation(gameId, locale);
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
              {games
                ...
                .map(otherGame => (
                  <Link 
                    key={otherGame.id}
                    href={otherGame.id === 'italian-brainrot-clicker' ? `/` : `/game/${otherGame.id}`}
                  ...
                  >
                    ...
                    <div className="p-3">
                      ...
                      <p className="text-gray-400 text-sm mt-1">{dict.games?.gamesList?.[otherGame.id]?.description || otherGame.description}</p>
                      <div className="mt-3">
